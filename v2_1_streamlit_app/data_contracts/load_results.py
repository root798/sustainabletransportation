...
# Resolve DATA_ROOT: this file lives at v2_streamlit_app/data_contracts/load_results.py
# Parent chain: data_contracts -> v2_streamlit_app -> CLEAR_ATS root
...
QUANTILE_PATHS = {
    ...
    # DU-INJECTED variant (California only)
